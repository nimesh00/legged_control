#include "legged_go2/xTerraDDS.h"
...
namespace legged {
bool xTerraDDS::init(ros::NodeHandle& root_nh, ros::NodeHandle& robot_hw_nh) {
    ...
    sensor_dds_sub_.reset(
        new DDSSubscriber<SensorData_>("rt/m2_metal/sim/sensor_data"));
    joint_dds_pub_.reset(
        new DDSPublisher<JointData_>("rt/m2_metal/sim/joint_command"));
    gt_dds_sub_.reset(new DDSSubscriber<QuadLog_>("rt/m2_metal/sim/gt_data"));
...
void xTerraDDS::read(const ros::Time& time, const ros::Duration& /*period*/) {
...
void xTerraDDS::writejointdataToDDS() {
    for (int i = 0; i < 12; ++i) {
...
void xTerraDDS::write(const ros::Time& /*time*/,
...
bool xTerraDDS::setupContactSensor(ros::NodeHandle& nh) {
...
void xTerraDDS::updateJoystick(const ros::Time& time) {
...
void xTerraDDS::updateContact(const ros::Time& time) {
...
// void xTerraDDS::copyLowStateFromDDS() {
//     for (int i = 0; i < 12; ++i) {
